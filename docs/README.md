...
This directory is the long-form documentation for the project. The root [README](../README.md) stays focused on the overview and quickstart, while these pages go deeper into setup, architecture, deployment, and operations.
...
6. [Celery Task Map](./celery-task-map.md)
