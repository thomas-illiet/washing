...
4. [Machine Optimizations](./optimizations.md)
...
- [Machine Optimizations](./optimizations.md): optimization inputs, API endpoints, calculation rules, statuses, and operations
